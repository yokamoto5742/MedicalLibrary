...
namespace MedicalLibrary.Entity
{
    ...
    /// PATH_M看護指示テンプレート
    /// </summary>
    public class NursingOrderPathTemplate : StdEntity
    {
        /// <summary>
        /// パスコード
        /// </summary>
        ...
        public static List<int> GetDateList(string path_code)
        {
            ...
            string cmd = "select distinct 日数 from PATH_M看護指示テンプレート " +
        ...
        /// <returns></returns>
        public static Dictionary<int, Dictionary<int, Dictionary<int, NursingOrderPathTemplate>>> Load(string path_code)
        {
            Dictionary<int, Dictionary<int, Dictionary<int, NursingOrderPathTemplate>>> dict = new Dictionary<int, Dictionary<int, Dictionary<int, NursingOrderPathTemplate>>>();
            ...
            foreach (StdClass tmp in tmp_list)
            {
                NursingOrderPathTemplate obj = new NursingOrderPathTemplate();
                ...
                Dictionary<int, Dictionary<int, NursingOrderPathTemplate>> dict2 = new Dictionary<int, Dictionary<int, NursingOrderPathTemplate>>();
                Dictionary<int, NursingOrderPathTemplate> dict3 = new Dictionary<int, NursingOrderPathTemplate>();
                ...
                {
                    dict2 = new Dictionary<int, Dictionary<int, NursingOrderPathTemplate>>();
                ...
                {
                    dict3 = new Dictionary<int, NursingOrderPathTemplate>();
