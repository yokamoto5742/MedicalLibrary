...
namespace MedicalLibrary.Agent
{
    ...
    public class PosRegHistory
    {
        ...
        public static PosRegHistory GetFromStdClass(StdClass tmp)
        {
            PosRegHistory obj = new PosRegHistory();

            obj.ADate = tmp.GetDataString("A_DATE");
            obj.ATime = tmp.GetDataString("A_TIME");
            obj.PtId = tmp.GetDataString("PT_ID");
            obj.BillId = tmp.GetDataString("BILL_ID");
            obj.SumMoney = tmp.GetDataInt("SUM_MONEY");
        ...
        /// <returns></returns>
        public static List<PosRegHistory> GetListByPat(string pt_id)
        {
            List<PosRegHistory> list = new List<PosRegHistory>();
            ...
            string cmd = "select * from POSREG_HISTORY" +
                " where PT_ID = " + pt_id +
        ...
        /// <returns></returns>
        public static List<PosRegHistory> GetListByPatDate(List<string> pt_id_list, string date)
        {
            List<PosRegHistory> list = new List<PosRegHistory>();
