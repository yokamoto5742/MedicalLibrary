...
namespace MedicalLibrary.Entity
{
    ...
    /// 手術指示マスター
    /// </summary>
    public class OpeOrderMaster : StdEntity
    {
        /// <summary>
        /// 指示コード
        /// </summary>
        ...
        static Dictionary<int, Dictionary<int, OpeOrderMaster>> dict = new Dictionary<int, Dictionary<int, OpeOrderMaster>>();

        public static Dictionary<int, Dictionary<int, OpeOrderMaster>> Dict
        {
            get
            {
                if (dict.Count == 0)
        ...
        public static void DictUpdate()
        {
            ...
            string cmd = "Select * from PATH手術指示マスター order by 指示コード, 連番";

            List<StdClass> tmp_list = StdClass.GetList(Db, cmd);

            foreach (StdClass tmp in tmp_list)
            {
                OpeOrderMaster master = new OpeOrderMaster();
                ...
                {
                    Dictionary<int, OpeOrderMaster> tmp_dict = new Dictionary<int, OpeOrderMaster>();
