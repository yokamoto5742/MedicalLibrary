...
namespace MedicalLibrary.Agent
{
    public class PatLabelSettings
    {
        ...
        string printer_small = "";

        public string PrinterSmall
        {
            get
            {
                return printer_small;
            }
        }
        ...
        public bool Init()
        {
            ...
            string XmlFile = AppFile.FilePath("PatLabel.xml");
            ...
            foreach (DataRow r in DSet.Tables["PC"].Rows)
            {
                if (pc_name.Equals(r["Name"].ToString()))
                {
                    ...
                    printer_small = r["PrinterSmall"].ToString();

                    if (r["PrintView"].ToString().Equals("1"))
                    {
                        print_view = true;
                    }
