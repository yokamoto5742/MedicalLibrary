...
{
    public partial class FormOpeOrder : StdForm1
    {
        public FormOpeOrder()
        {
            InitializeComponent();
        ...
        private void FormOpeOrder_Load(object sender, EventArgs e)
        {
            this.Pat = AppStat.CurrentPat;

            Dictionary<int, Dictionary<int, OpeOrderMaster>> dict = OpeOrderMaster.Dict;
            ...
            {
                Dictionary<int, OpeOrderMaster> tmp_dict = dict[code1];
                ...
                {
                    OpeOrderMaster obj = tmp_dict[code2];
        ...
        void PtShow()
        {
            ...
            List<int> list = OpeOrderData.GetDateList(this.Pat.Id);
        ...
        void DataShow()
        {
            ...
            Dictionary<int, Dictionary<int, OpeOrderData>> data_dict = OpeOrderData.LoadByDate(this.Pat.Id, crit_date);

            Dictionary<int, Dictionary<int, OpeOrderMaster>> master_dict = OpeOrderMaster.Dict;
                ...
                if (data_dict.ContainsKey(code1))
                {
                    ...
                    foreach (int code2 in master_dict[code1].Keys)
                    {
                        if (data_dict[code1].ContainsKey(code2))
                        {
                            ...
                            OpeOrderMaster master = master_dict[code1][code2];
        ...
        StdReturn DataSave()
        {
            ...
            // 既存のデータがあれば削除する
            sr.Msgs.Add(OpeOrderData.Delete(pt_id, order_date).Msg);
            ...
            foreach (Control pc in Panel1.Controls)
            {
                ...
                foreach (Control c in fp.Controls)
                {
                    ...
                    OpeOrderMaster m = (OpeOrderMaster)(c.Tag);
        ...
        StdReturn DataDelete()
        {
            ...
            {
                // 登録処理を行う。
                sr = OpeOrderData.Delete(pt_id, crit_date);
            }

            string msg = "";

            msg = "手術指示を削除しました。" + Environment.NewLine;
